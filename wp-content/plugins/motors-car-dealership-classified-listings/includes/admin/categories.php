...
function stm_add_listing_patch_menu_item() {
    add_submenu_page(
        'edit.php?post_type=listings',
        __("Patch", 'stm_vehicles_listing'),
        __("Patch", 'stm_vehicles_listing'),
        'manage_options',
        'patch',
        'stm_listings_vehicle_listing_patch_page'
    );
}

add_action("admin_menu", "stm_add_listing_patch_menu_item");

function stm_listings_vehicle_listing_patch_page () {
    require_once "screens/patching.php";
}
